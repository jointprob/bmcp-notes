...
from projects.common.berlin_housing.utils.data_utils import destandardize_area, destandardize_price, load_data
...
def plot_price_area():
    ...
    # plt.ylim(0, 1500000)
    # plt.xlim(0, 400)
    ax.scatter(d["living_space"], d["rent"], s=1.8, c="#737373", alpha=0.3)
